...
I spend some time talking about this in the [Finnish WordPress related slack channel](https://fi.wordpress.org/chat/) and @tsipilai had mentioned flexboxfroggy.com as a nice and fun way to learn css flexing.
